...
class TestInputGuard:
    ...
    def test_aero_dist_unused_parameter():
        ...
        # assert
        assert str(exc_info.value) == "WARNING: \"test_mode/not_used\" parameter remains unused."
    ...
    def test_nested_unused_parameter():
        ...
        # assert
        assert str(exc_info.value) == "WARNING: \"test_mode/size_dist2/diam\" parameter remains unused."
    ...
    def test_same_name_unused_parameter():
        ...
        # assert
        assert str(exc_info.value) == "WARNING: \"sampled_mode/geom_mean_diam\" parameter remains unused."