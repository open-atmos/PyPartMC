...
module PyPartMC_run_exact
  ...
  subroutine f_run_exact( &
    bin_grid_ptr_c, &
    scenario_ptr_c, &
    env_state_ptr_c, &
    aero_data_ptr_c, &
    aero_dist_init_ptr_c, &
    gas_data_ptr_c, &
    run_exact_opt_ptr_c &
  ) bind(C)
    ...
    type(c_ptr), intent(in) :: aero_dist_init_ptr_c
    type(aero_dist_init_t), pointer :: aero_dist_init_ptr_f => null()

    type(c_ptr), intent(in) :: gas_data_ptr_c
    type(gas_data_t), pointer :: gas_data_ptr_f => null()

    type(c_ptr), intent(in) :: run_exact_opt_ptr_c
    type(run_exact_opt_t), pointer :: run_exact_opt_ptr_f => null()
