...
contains
  ...
  subroutine f_input_sectional(filename_data, filename_size, index, time, del_t, &
       bin_grid_ptr_c, aero_data_ptr_c, aero_binned_ptr_c, gas_data_ptr_c, &
       gas_state_ptr_c, env_state_ptr_c) bind(C)

    type(aero_binned_t), pointer :: aero_binned_ptr_f => null()
    type(aero_data_t), pointer :: aero_data_ptr_f => null()
    ...
    call c_f_pointer(aero_data_ptr_c, aero_data_ptr_f)
    call c_f_pointer(aero_binned_ptr_c, aero_binned_ptr_f)
  ...
  subroutine f_input_exact(filename_data, filename_size, index, time, del_t, &
       bin_grid_ptr_c, aero_data_ptr_c, aero_binned_ptr_c, gas_data_ptr_c, &
       gas_state_ptr_c, env_state_ptr_c) bind(C)
