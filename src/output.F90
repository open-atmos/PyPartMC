...
contains
  ...
  subroutine f_input_state(index, time, del_t, i_repeat, aero_data_ptr_c, aero_state_ptr_c, &
    gas_data_ptr_c, gas_state_ptr_c, env_state_ptr_c) bind(C)
    ...
    filename = 'test_0001_00000001.nc'
    ...
    call input_state(filename, index, time, del_t, i_repeat, uuid, &
         aero_data_ptr_f, aero_state_ptr_f, &
         gas_data_ptr_f, gas_state_ptr_f, env_state_ptr_f)
